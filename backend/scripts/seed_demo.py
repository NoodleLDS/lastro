...
from lastro.core.config import settings as _settings
...
from lastro.models.transaction import CategorizedBy, Transaction, TransactionSource, TransactionStatus
...
with Session(engine) as session:
    ...
    # ── Categories ────────────────────────────────────────────────────────────
    categories = [
        "Alimentação", "Transporte", "Saúde", "Lazer", "Assinaturas",
        "Moradia", "Educação", "Vestuário", "Supermercado", "Outros",
    ]
    ...
    rules = [
        ...
        ("uber", "Transporte"), ("99", "Transporte"),
        ("spotify", "Assinaturas"), ("netflix", "Assinaturas"), ("amazon prime", "Assinaturas"),
        ("farmácia", "Saúde"), ("droga", "Saúde"), ("médico", "Saúde"),
        ("cinema", "Lazer"), ("bar", "Lazer"),
        ("supermercado", "Supermercado"), ("mercado", "Supermercado"), ("pão de açúcar", "Supermercado"),
    ]
    rule_count = 0
    ...
    # ── Positions ─────────────────────────────────────────────────────────────
    positions_data = [
        dict(ticker="CPTS11", name="Capitânia Securities II", asset_type=AssetType.FII,
             target_yield_pct=12.0),
        dict(ticker="XPML11", name="XP Malls", asset_type=AssetType.FII,
             target_yield_pct=9.0),
        dict(ticker="HGLG11", name="CSHG Logística", asset_type=AssetType.FII,
             target_yield_pct=9.5),
        dict(ticker="IVVB11", name="iShares S&P 500 (BR)", asset_type=AssetType.ETF),
        dict(ticker="BBAS3", name="Banco do Brasil", asset_type=AssetType.STOCK,
             roe_percentage=18.0, price_earnings=5.2),
        dict(ticker="TESOURO IPCA+ 2035", name="Tesouro IPCA+ 2035", asset_type=AssetType.FIXED_INCOME),
