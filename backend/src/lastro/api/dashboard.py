...
from lastro.services.analytics.financial_summary import FinancialSummary, fetch_financial_summary
...
async def get_financial_summary(
    ...
    return await fetch_financial_summary(session, year, month)
